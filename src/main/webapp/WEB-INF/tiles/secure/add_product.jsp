        ...
        <form:form method="POST" action="${contextRoot}/secure/addNewProduct" modelAttribute="productForm">
          <div class="col-xs-12 col-sm-6">
            ...
            <div class="form-group required">
              ...
              <form:input type="text" class="form-control" id="productDescription" path="productDescription"/>
          ...
          <div class="col-xs-12 col-md-12">
            <div class="form-group required">
              ...
              <form:input type="text" path="image1Loc" class="form-control" id="image1Loc" />
              <form:errors path="image1Loc"  cssClass="error"/>
            </div>
            
            <div class="form-group required">
              <label for="image2Loc"> Image Url 2</label>
              <form:input type="text" path="image2Loc" class="form-control" id="image2Loc" />
            </div>
            
            <div class="form-group required">
              <label for="image3Loc"> Image Url 3</label>
              <form:input type="text" path="image3Loc" class="form-control" id="image3Loc" />
            </div>
            
            <div class="form-group required">
              <label for="image4Loc"> Image Url 4</label>
              <form:input type="text" path="image4Loc" class="form-control" id="image4Loc" />
            </div>
            
            <div class="form-group required">
              <label for="image5Loc"> Image Url 5</label>
              <form:input type="text" path="image5Loc" class="form-control" id="image5Loc" />
            </div>
             <div class="form-group required">
              <label for="image1Thumb"> ThumbNail Url 1</label>
              <form:input type="text" path="image1Thumb" class="form-control" id="image1Thumb" />
            </div>
            
            <div class="form-group required">
              <label for="image2Thumb"> ThumbNail Url 2</label>
              <form:input type="text" path="image2Thumb" class="form-control" id="image2Thumb" />
            </div>
            
            <div class="form-group required">
              <label for="image3Thumb"> ThumbNail Url 3</label>
              <form:input type="text" path="image3Thumb" class="form-control" id="image3Thumb" />
            </div>
            
            <div class="form-group required">
              <label for="image4Thumb"> ThumbNail Url 4</label>
              <form:input type="text" path="image4Thumb" class="form-control" id="image4Thumb" />
            </div>
            
            <div class="form-group required">
              <label for="image5Thumb"> ThumbNail Url 5</label>
              <form:input type="text" path="image5Thumb" class="form-control" id="image5Thumb" />
            </div>
            <div class="form-group required">
