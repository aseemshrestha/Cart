...
<div class="navbar navbar-tshop navbar-fixed-top megamenu"
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6">
          <div class="pull-left ">
            <ul class="userMenu ">
              ...
              <li class="phone-number"><a href="callto:+1000-000-0000">
                <span> <i class="glyphicon glyphicon-phone-alt"></i></span> <span class="hidden-xs" style="margin-left: 5px">+1-000-000-0000 </span></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6 no-margin no-padding">
          <div class="pull-right">
            <ul class="userMenu">
              <li><a href="/signup"><span class="hidden-xs">My Account</span> <i class="glyphicon glyphicon-user hide visible-xs "></i></a></li>
              <li><a href="/signup" data-toggle="modal"> <span class="hidden-xs">Sign In</span> <i class="glyphicon glyphicon-log-in hide visible-xs "></i></a></li>
              <li class="hidden-xs"><a href="/signup" data-toggle="modal" data-target="#ModalSignup"> Create Account </a></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand " href="index.html"> <img  src="${contextRoot}/assets/images/logo.png" alt="TSHOP"></a>
      ...
      <div class="cartMenu  col-lg-4 col-xs-12 col-md-4 ">
            ...
            <tbody>
                ...
                <td style="width: 20%" class="miniCartProductThumb">
                  <div>
                    <a href="product-details.html"> <img
                      src="${contextRoot}/assets/images/product/3.jpg" alt="img">
                    </a>
                  </div>
                </td>
                <td style="width: 40%">
              ...
              <tr class="miniCartProduct">
                <td style="width: 20%" class="miniCartProductThumb">
                  <div>
                    <a href="product-details.html"> <img
                      src="${contextRoot}/assets/images/product/2.jpg" alt="img">
                    </a>
                  </div>
                </td>
                <td style="width: 40%">
              ...
              <tr class="miniCartProduct">
                <td style="width: 20%" class="miniCartProductThumb">
                  <div>
                    <a href="product-details.html"> <img
                      src="${contextRoot}/assets/images/product/5.jpg" alt="img">
                    </a>
                  </div>
                </td>
                <td style="width: 40%">
              ...
              <tr class="miniCartProduct">
                <td style="width: 20%" class="miniCartProductThumb">
                  <div>
                    <a href="product-details.html"> <img
                      src="${contextRoot}/assets/images/product/4.jpg" alt="img">
                    </a>
                  </div>
                </td>
                <td style="width: 40%">
        ...
        <div class="miniCartFooter  miniCartFooterInMobile text-right">
          ...
          <a class="btn btn-sm btn-danger" href="cart.html"> <i
            class="glyphicon glyphicon-shopping-cart"> </i> VIEW CART
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
            ...
            <li class="megamenu-content ">
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3  col-xs-4">
                <li><a class="newProductMenuBlock"
                  ...
                  src="${contextRoot}/assets/images/site/promo1.jpg"
                  alt="product"> <span class="ProductMenuCaption">
                  <i class="glyphicon glyphicon-shopping-cart"> </i> JEANS
                  </span>
                  </a>
                </li>
              </ul>
              <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                <li><a class="newProductMenuBlock"
                  href="product-details.html"> <img class="img-responsive"
                  src="${contextRoot}/assets/images/site/promo2.jpg"
                  alt="product"> <span class="ProductMenuCaption">
                  <i class="glyphicon glyphicon-shopping-cart"> </i> PARTY
                  DRESS
                  </span>
                  </a>
                </li>
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                <li><a class="newProductMenuBlock"
                  href="product-details.html"> <img class="img-responsive"
                  src="${contextRoot}/assets/images/site/promo3.jpg"
                  alt="product"> <span class="ProductMenuCaption">
                  <i class="glyphicon glyphicon-shopping-cart"> </i> SHOES
                  </span>
                  </a>
                </li>
              </ul>
        ...
        <li class="dropdown megamenu-80width ">
          <a
            data-toggle="dropdown" class="dropdown-toggle" href="#"> SHOP <b
            class="caret"> </b>
          </a>
          <ul class="dropdown-menu">
            <li class="megamenu-content">
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                <li class="no-margin productPopItem "><a
                  href="product-details.html"> <img class="img-responsive"
                  src="${contextRoot}/assets/images/site/g4.jpg" alt="img">
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                <li class="no-margin productPopItem relative"><a
                  href="product-details.html"> <img class="img-responsive"
                  src="${contextRoot}/assets/images/site/g5.jpg" alt="img">
                  </a> <a class="text-center productInfo alpha90"
                    href="product-details.html"> Eodem modo typi <br> <span>
                  $60 </span>
                  </a>
        ...
        <li class="dropdown megamenu-fullwidth">
          ...
          <ul class="dropdown-menu">
            <li class="megamenu-content ProductDetailsList">
              ...
              <!-- megamenu-content -->
              <h3 class="promo-1 no-margin hidden-xs">60 + HTML PAGES ||
                AVAILABLE ONLY AT WRAP BOOTSTRAP
              </h3>
              <h3 class="promo-1sub hidden-xs">Complete Parallax
                E-Commerce Boostrap Template, Responsive on any Device, 10+
                color Theme + Parallax Effect
              </h3>
              <ul class="col-lg-2  col-sm-2 col-md-2 unstyled">
                <li class="no-border">
                  <p>
                ...
                <li><a href="index-v-7.html"> Home Version 7 (Flat) <span
                  class="label label-success">new</span></a></li>
                <li><a href="index-header2.html"> Header Version 2 </a></li>
                <li><a href="index-header3.html"> Header Version 3 </a></li>
                <li><a href="index-logged-in.html">Topbar Logged In
                  user menu <span class="label label-success">new</span>
                  </a>
                </li>
                <li><a href="sidebar-shopping-cart.html">Sidebar
                  Shopping cart <span class="label label-success">new</span>
                  </a>
                </li>
              </ul>
              <ul class="col-lg-2  col-sm-2 col-md-2 unstyled">
                ...
                <li><a href="contact-us-2.html"> Contact us 2 (No Fixed
                  Map) </a>
                </li>
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3 unstyled ">
                ...
                <li><a href="product-details.html"> Product Details v1
                  </a>
                </li>
                ...
                <li><a href="product-details-style3.html"> Product
                  Details v 3 (Custom Thumbnail Position)</a>
                </li>
                <li><a href="product-details-style4.html"> Product
                  Details v 4 (with litebox)</a>
                </li>
                <li><a href="product-details-style5.html"> Product
                  Details v 5 (Flat) <span class="label label-success">NEW</span>
                  </a>
                </li>
                <li><a href="product-details-style5-1.html"> Product
                  Details v 5.1 <span class="label label-success">NEW</span>
                  </a>
                </li>
                <li><a href="product-details-style5-2.html"> Product
                  Details v 5.2 <span class="label label-success">NEW</span>
                  </a>
                </li>
                <li><a href="product-details-style5-3.html"> Product
                  Details v 5.3 <span class="label label-success">NEW</span>
                  </a>
                </li>
                <li><a href="product-details-style5-3-fadein.html">
                  Product Details v 5.3.1 <small>(fadein)</small> <span
                    class="label label-success">NEW</span>
                  </a>
                </li>
                <li><a href="product-details-style5-4.html"> Product
                  Details v 5.4 <span class="label label-success">NEW</span>
                  </a>
                </li>
                <li><a href="product-details-style5-4.1-popup-video.html">
                  Product Details v 5.4.1 <small>(popup video)</small> <span
                    class="label label-success">NEW</span>
                  </a>
                </li>
                <li><a href="product-details-style5-4.1-with-zoom.html">
                  Product Details v 5.4.1 <small>(zoom + litebox)</small> <span
                    class="label label-success">NEW</span>
                  </a>
                </li>
              </ul>
              <ul class="col-lg-2  col-sm-2 col-md-2 unstyled">
                ...
                <li><a href="one-page-checkout.html"> One page checkout
              ...
              <ul class="col-lg-2  col-sm-2 col-md-2 unstyled">
                ...
                <li><a href="single-product-modal.html"> Single Product
                  Details Modal</a>
                </li>
                <li><a href="single-subscribe-modal.html"> Single
                  Subscribe Modal</a>
                </li>
                <li><a href="index-store-switcher-modal.html"> store
                  switcher modal</a>
                </li>
        ...
        <li><a href="all-page-link.html" target="_blank"> All Page
          Link </a>
        </li>
      </ul>
  ...
  <div class="search-full text-right">
    <a class="pull-right search-close"> <i class="glyphicon glyphicon-remove-circle"></i></a>
  </div>
  <div class="search-full text-right">
    <a class="pull-right search-close"><i class="glyphicon glyphicon-remove-circle"></i></a>
