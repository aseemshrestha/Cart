...
$(document).ready(function () {
    ...
    function customPager() {
        ...
        $.each(this.owl.userItems, function (i) {
            ...
            $(pagination[i]).append("<div class=' owl-has-nav owl-next'><i class='glyphicon glyphicon-chevron-right'></i>  </div>");
            $(pagination1[i]).before("<div class=' owl-has-nav owl-prev'><i class='glyphicon glyphicon-chevron-left'></i> </div>");
